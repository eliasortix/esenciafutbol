...
<div class="container py-4">
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Modifica todos los datos del producto</p>
        </div>
            ...
            <form action="{{ route('products.update', $product) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0" name="cost" class="form-control" value="{{ old('cost', $product->cost) }}" placeholder="0.00">
                    </div>
                </div>
